...
describe LoadTests::LineFactory do
  ...
  context 'a CPU log line' do
    ...
    it {
      expect(subject).to be_instance_of LoadTests::Line::CpuLine
  ...
  context 'a free memory log line' do
    ...
    it {
      expect(subject).to be_instance_of LoadTests::Line::MemoryLine
  ...
  context 'a session line' do
    ...
    it {
      expect(subject).to be_instance_of LoadTests::Line::SessionLine
